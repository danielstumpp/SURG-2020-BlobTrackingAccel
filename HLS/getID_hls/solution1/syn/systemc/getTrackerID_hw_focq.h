...
// ==============================================================
#ifndef __getTrackerID_hw_focq__HH__
#define __getTrackerID_hw_focq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(getTrackerID_hw_focq) {
    ...
    SC_CTOR(getTrackerID_hw_focq):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
