...
// ==============================================================
#ifndef __getTrackerID_hw_fmb6__HH__
#define __getTrackerID_hw_fmb6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(getTrackerID_hw_fmb6) {
    ...
    SC_CTOR(getTrackerID_hw_fmb6):  ACMP_fpext_U ("ACMP_fpext_U") {
