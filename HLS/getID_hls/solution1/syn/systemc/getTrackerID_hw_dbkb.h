...
// ==============================================================
#ifndef __getTrackerID_hw_dbkb__HH__
#define __getTrackerID_hw_dbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(getTrackerID_hw_dbkb) {
    ...
    SC_CTOR(getTrackerID_hw_dbkb):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
