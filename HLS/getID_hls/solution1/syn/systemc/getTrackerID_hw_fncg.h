...
// ==============================================================
#ifndef __getTrackerID_hw_fncg__HH__
#define __getTrackerID_hw_fncg__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(getTrackerID_hw_fncg) {
    ...
    SC_CTOR(getTrackerID_hw_fncg):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
