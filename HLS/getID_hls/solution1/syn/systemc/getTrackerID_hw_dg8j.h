...
// ==============================================================
#ifndef __getTrackerID_hw_dg8j__HH__
#define __getTrackerID_hw_dg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(getTrackerID_hw_dg8j) {
    ...
    SC_CTOR(getTrackerID_hw_dg8j):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
