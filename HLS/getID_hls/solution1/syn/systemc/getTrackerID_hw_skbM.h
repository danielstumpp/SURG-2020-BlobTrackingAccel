...
// ==============================================================
#ifndef __getTrackerID_hw_skbM__HH__
#define __getTrackerID_hw_skbM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(getTrackerID_hw_skbM) {
    ...
    SC_CTOR(getTrackerID_hw_skbM):  ACMP_sitofp_U ("ACMP_sitofp_U") {
