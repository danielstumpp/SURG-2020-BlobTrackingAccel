...
// ==============================================================
#ifndef __getTrackerID_hw_deOg__HH__
#define __getTrackerID_hw_deOg__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(getTrackerID_hw_deOg) {
    ...
    SC_CTOR(getTrackerID_hw_deOg):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
