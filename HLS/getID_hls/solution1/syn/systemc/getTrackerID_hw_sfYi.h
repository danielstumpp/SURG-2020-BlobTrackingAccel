...
// ==============================================================
#ifndef __getTrackerID_hw_sfYi__HH__
#define __getTrackerID_hw_sfYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(getTrackerID_hw_sfYi) {
    ...
    SC_CTOR(getTrackerID_hw_sfYi):  ACMP_sitodp_U ("ACMP_sitodp_U") {
