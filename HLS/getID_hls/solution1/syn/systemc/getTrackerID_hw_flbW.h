...
// ==============================================================
#ifndef __getTrackerID_hw_flbW__HH__
#define __getTrackerID_hw_flbW__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(getTrackerID_hw_flbW) {
    ...
    SC_CTOR(getTrackerID_hw_flbW):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
