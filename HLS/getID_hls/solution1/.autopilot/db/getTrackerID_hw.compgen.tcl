...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 45 \
			corename getTrackerID_hw_AXILiteS_axilite \
			name getTrackerID_hw_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler getTrackerID_hw_AXILiteS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename newFlow \
    op interface \
    ports { newFlow_address0 { O 1 vector } newFlow_ce0 { O 1 bit } newFlow_q0 { I 64 vector } newFlow_address1 { O 1 vector } newFlow_ce1 { O 1 bit } newFlow_q1 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'newFlow'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_maxProb \
    op interface \
    ports { maxProb { O 64 vector } maxProb_ap_vld { O 1 bit } } \
} "
}
